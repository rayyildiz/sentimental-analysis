...
import me.rayyildiz.sentiment_analyzer
import me.rayyildiz.sentiment_analyzer.modules.{AkkaModule, ConfigModule}
...
object BootApplication extends App {
  ...
  val routes: Route = {
    val routes = injector.getInstance(classOf[sentiment_analyzer.Routes])
    routes()
  }
